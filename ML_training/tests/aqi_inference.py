...
model_path = (
    base_dir.parent.parent / "server" / "infrastructure" / "ml" / "models_store"
)


# Load model dan encoder (pastikan path benar)
with open(model_path / "xgboost_final_model.pkl", "rb") as f:
    best_xgb = pickle.load(f)

with open(model_path / "le_country.pkl", "rb") as f:
    le_country = pickle.load(f)

with open(model_path / "le_loc.pkl", "rb") as f:
    le_loc = pickle.load(f)

with open(model_path / "le_cat.pkl", "rb") as f:
